...
public class RepositoryTest {
	...
	public void testAdd() {
		repository.addEmployee(IVANOV);
		assertArrayEquals(new Employee[]{IVANOV}, toArray(repository.getAll()));
		assertEquals(true,repository.addEmployee(KATS));
		assertEquals(false,repository.addEmployee(KATS));
		assertArrayEquals(new Employee[]{IVANOV,KATS}, toArray(repository.getAll()));
	}
	...
	public void testRemove() {
		...
		assertArrayEquals(new Employee[]{KATS,ADMINOV},toArray( repository.getAll()));
		repository.removeEmployee(ID2);
		assertArrayEquals(new Employee[]{ADMINOV}, toArray(repository.getAll()));
	}
	...
	public void testGetByCompany(){
		...
		repository.addEmployee(KATS);
		repository.addEmployee(ADMINOV);
		assertArrayEquals(new Employee[]{KATS,ADMINOV},toArray( repository.getEmployeeByCompany(COMPANY2)));
		assertArrayEquals(new Employee[]{IVANOV},toArray( repository.getEmployeeByCompany(COMPANY1)));
		repository.removeEmployee(ID1);
		assertArrayEquals(new Employee[]{},toArray( repository.getEmployeeByCompany(COMPANY1)));
	}
	...
	public void testGetByName(){
		...
		repository.addEmployee(KATS);
		repository.addEmployee(ADMINOV);
		assertArrayEquals(new Employee[]{KATS},toArray( repository.getEmployeeByName(NAME2)));
		assertArrayEquals(new Employee[]{IVANOV},toArray( repository.getEmployeeByName(NAME1)));
		assertArrayEquals(new Employee[]{},toArray( repository.getEmployeeByName(NAME4)));
	}
	@Test	
	public void testGetBySalary(){
		...
		repository.addEmployee(KATS);
		repository.addEmployee(ADMINOV);
		assertArrayEquals(new Employee[]{IVANOV,KATS},toArray( repository.getEmployeeBySalary(29000, 41000)));
		assertArrayEquals(new Employee[]{IVANOV},toArray( repository.getEmployeeBySalary(29000, 31000)));
		assertArrayEquals(new Employee[]{}, toArray(repository.getEmployeeBySalary(100, 10000)));
	}
	public static Employee [] toArray(List<Employee> employees){
